...
Ensure the suggestions are grammatically correct, friendly, and brief. Do not output other text after the suggestions line.`;
    ...
    try {
      ...
      res.write(`event: status\ndata: ${JSON.stringify({ phase: 'running_analysis_model', message: '[STATUS: Activating Inner Analytical Engine...]' })}\n\n`);
...
Provide this as a raw structured contextual report. Be extremely concise.`;
      ...
      res.write(`event: status\ndata: ${JSON.stringify({ phase: 'running_final_writer', message: '[STATUS: Core data finalized. Passing to presentation model...]' })}\n\n`);
