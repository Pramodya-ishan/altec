...
old_summary = r'\{summaryExpanded && msg\.summary && msg\.summary\.length > 0 && \(\s*<div className="pt-2 border-t border-slate-200/50">\s*<SafeReasoningSummary items=\{msg\.summary\} />\s*</div>\s*\)\}'

new_summary = """{summaryExpanded && (
...
c = re.sub(old_summary, new_summary, c)
