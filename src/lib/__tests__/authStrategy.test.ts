...
assert.equal(shouldUseRedirectAuth({ standalone: false, userAgent: "Mozilla/5.0 Windows", viewportWidth: 1280 }), true);
...
console.log("redirect-only auth strategy tests passed");
