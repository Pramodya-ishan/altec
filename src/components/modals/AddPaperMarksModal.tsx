...
export function AddPaperMarksModal() {
  ...
  const handleSave = () => {
    ...
    const total = parsedMcq + parsedEssay;
    const maxTotal = currentSubject === 'et' ? 70 : 100;
      ...
      <div className="bg-white w-full max-w-sm rounded-2xl shadow-xl overflow-hidden flex flex-col">
        ...
        <div className="p-6 flex flex-col gap-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex flex-col gap-1.5">
              <label className="text-sm font-semibold text-slate-700">MCQ Marks</label>
              <input
                type="number"
                min="0"
                placeholder="0"
            ...
            <div className="flex flex-col gap-1.5">
              <label className="text-sm font-semibold text-slate-700">Essay Marks</label>
              <input
                type="number"
                min="0"
                placeholder="0"
