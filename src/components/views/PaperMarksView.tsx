...
export default function PaperMarksView() {
 ...
 showNotification('Marks record deleted.', 'info');
 };
 ...
 >
 <span className="text-sm font-black text-slate-800">MCQ and Essay Marks</span>
 ...
 No marks have been recorded yet. Select “+” to add your first result.
 </div>
 ) : (
 ...
 <button onClick={() => setConfirmDeleteIdx(idx)} className="hover:text-rose-600 p-1 cursor-pointer transition-colors" title="Delete record">
